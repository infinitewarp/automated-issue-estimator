...
def main():
    ...
    predict_parser = subparsers.add_parser("predict", help="Predict size for a user story")
    predict_parser.add_argument("--repl", action="store_true", help="Run in interactive REPL mode")
    predict_parser.add_argument("--text", type=str, help="Single prediction for given story text")
