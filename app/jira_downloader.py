...
def get_auth():
    ...
    auth_password = (
        env_password or conf_password or getpass("Jira Personal Access Token: ")
    )
...
def download():
    with Path("stories.json").open("w", encoding="utf-8") as f:
        json.dump(get_issue_data(), f, indent=2)
